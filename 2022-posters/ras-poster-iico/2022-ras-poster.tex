...
\node[anchor=north east,xshift=-1.5cm,yshift=-18cm](str) at (current page.north east) {\includegraphics[width=0.3\textwidth]{figures/structure.pdf}};
...
\node[draw,
      ...
      scale=4.5,
	  color=blue,
	  font=\bfseries] at (13.85cm,-60cm) {METHODOLOGY};
...
\draw[draw=none,
      blue,
      postaction={decorate},
      decoration={text along path,text={|\bfseries\fontsize{60}{10}\selectfont\color{blue}\myshift|CONCLUTIONS},text align=center}]
...
\node[anchor=south east,xshift=-5cm,yshift=10cm](RAS) at (current page.south east){\includegraphics[width=0.25\textwidth]
