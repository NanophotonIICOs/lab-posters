...
\begin{document}
	...
	\begin{abstract}
		...
		and the interaction between the tip and the sample is due optical processes. In this work we show the first results of the development  of a Near-Field Microscope where its artisanal construction gives it some advantages from comercial ones.
